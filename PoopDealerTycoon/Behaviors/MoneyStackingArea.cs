...
namespace Chameleon.Game.ArcadeIdle
{
    public class MoneyStackingArea : MonoBehaviour
    {
        ...
        [SerializeField] private List<GameObject> _moneyInStackArea = new List<GameObject>();
        ...
        public void AddMoney(int amount)
        {
            ...
            while(spawnedAmount < amount)
            {
                if(_moneyAmountInStock < _maxPhysicalMoneyAmount)
                {
                    ...
                    GameObject money = ObjectPool.instance.SpawnFromPool("CollectableMoney", moneySpawnPos, Quaternion.identity);
        ...
        public void CollectMoney(Transform playerTransform)
        {
            ...
            {
                StartCoroutine(StartAnimatingMoneys(playerTransform));
                
            }
        }

        private IEnumerator StartAnimatingMoneys(Transform playerTransform)
        {
